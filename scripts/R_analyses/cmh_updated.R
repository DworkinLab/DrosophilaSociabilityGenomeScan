...
sync <- read_sync(file = "/Users/arteen/Desktop/pop_gen_out/actual_sync/UVD_subsetted_X.sync", 
                  gen=gen,
                  repl=reps, 
                  polarization = "minor", 
...
sync <- read_sync(file = "/Users/arteen/Desktop/pop_gen_out/actual_sync/UVD_subsetted_autosomes.sync", 
                  gen=gen,
                  repl=reps, 
                  polarization = "minor", 
                  keepOnlyBiallelic = TRUE)
...
actual_vals <- rbind(data_auto, data_X)
write.csv(actual_vals, "/Users/arteen/Desktop/pop_gen_out/revisions/lowVhigh/top_1_percent_ACER_PVALS.csv")

write.table(x = results, file = "/Users/arteen/Desktop/pop_gen_out/revisions/lowVhigh/cmh_top0.1.bed",
            sep = '\t',col.names = F, row.names = FALSE, quote = FALSE)

write.csv(x_full_values, "/Users/arteen/Desktop/pop_gen_out/revisions/lowVhigh/acer_low_vs_high_pvalues_X_chrom.csv")
write.csv(auto_full_values, "/Users/arteen/Desktop/pop_gen_out/revisions/lowVhigh/acer_low_vs_high_pvalues_autosomes.csv")
