...
`.sync` files of allele counts and coverage by samples.Split between autosomes and X chromosomes. See below for more information on how they are generated (mostly via the shell scripts) and the Rscripts for analysis.
